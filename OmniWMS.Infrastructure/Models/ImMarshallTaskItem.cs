...
{
    public partial class ImMarshallTaskItem
    {
        ...
        public Guid? PickShortReasonCodeIndex { get; set; }
        public string PickShortReasonCodeId { get; set; }
        public string PickShortReasonCodeName { get; set; }
        public string PickShortReasonCodeBy { get; set; }
        public DateTime? PickShortReasonCodeDate { get; set; }
        public string PickingToolReasonCodeBy { get; set; }
        public DateTime? PickingToolReasonCodeDate { get; set; }
        public decimal? QtyPiecePickShort { get; set; }
        public decimal? QtyPiecePickingTool { get; set; }
    }
}
