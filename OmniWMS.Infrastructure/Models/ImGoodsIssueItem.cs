...
{
    public partial class ImGoodsIssueItem
    {
        public ImGoodsIssueItem()
        {
            ImStockCardReserve = new HashSet<ImStockCardReserve>();
        }
        ...
        public virtual ImGoodsIssue GoodsIssueIndexNavigation { get; set; }
        ...
        public virtual ICollection<ImStockCardReserve> ImStockCardReserve { get; set; }
    }
}
